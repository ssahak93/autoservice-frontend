  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(-45deg, #667eea, #764ba2, #f093fb, #4facfe)',
        'gradient-subtle': 'linear-gradient(180deg, #f9fafb 0%, #f3f4f6 100%)',
        'mesh-blue':
          'radial-gradient(at 0% 0%, #3b82f6 0px, transparent 50%), radial-gradient(at 100% 0%, #8b5cf6 0px, transparent 50%), radial-gradient(at 100% 100%, #ec4899 0px, transparent 50%), radial-gradient(at 0% 100%, #06b6d4 0px, transparent 50%)',
      },
      animation: {
