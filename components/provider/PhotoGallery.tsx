...
import { type ProviderBranch, type PhotoItem } from '@/lib/services/provider-branch.service';
...
export function PhotoGallery({ profile: initialProfile }: PhotoGalleryProps) {
  ...
  const [localProfile, setLocalProfile] = useState<ProviderBranch>(initialProfile);
  ...
  const deleteMutation = useDeletePhoto(
    ...
    (context) => {
      ...
      if (context && typeof context === 'object' && 'previousProfile' in context) {
        setLocalProfile(context.previousProfile as ProviderBranch);
      }
    }
  );
