...
import type { EngineType, LpgType } from '@/types';

const createVehicleSchema = (t: (key: string, options?: { defaultValue?: string }) => string) => {
  return z.object({
    make: z.string().min(2, t('makeRequired', { defaultValue: 'Make is required' })),
    model: z.string().min(2, t('modelRequired', { defaultValue: 'Model is required' })),
    year: z
      .number()
      .int()
      .min(1900)
    ...
    engineType: z
      ...
      .optional()
      .nullable(),
    hasLpgSystem: z.boolean().default(false),
    ...
    createVehicle(
      {
        ...
        technicalPassport: data.technicalPassport || undefined,
      ...
      {
        onSuccess: () => {
          showToast(t('vehicleCreated', { defaultValue: 'Vehicle added successfully' }), 'success');
          reset();
          onClose();
          if (onSuccess) {
            onSuccess();
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            >
              <div className="mb-4 flex items-center justify-between">
                <h2 id="add-vehicle-title" className="font-display text-xl font-bold">
